...
// Static stars: 30 dots scattered across the top 65% of the hero sky
// 5 of them have a slow twinkle animation
...
// Blur-to-sharp "materialize" effect for text elements
...
export function Hero() {
  ...
  // Timing: total ~1.5s
  // Landscape: 0s start, 0.6s slide up
  // Moon: 0s start, 0.6s rise (overshoot)
  // Wordmark: 0.5s delay, 0.25s materialize
  // Tagline: 0.6s delay, 0.25s materialize
  // CTA: 0.7s delay, 0.25s materialize
  ...
  return (
    ...
    >
      {/* Stars layer — z-[1], behind everything */}
      ...
      {/* Center content — z-[5], above everything */}
      <div className="relative z-[5] flex flex-col items-center text-center px-6 max-w-[720px]">
        {/* Logo row: moon icon + "QuestLab" wordmark */}
        <div className="flex items-center gap-3 mb-6">
          {/* Moon logo — rises from behind landscape */}
          <motion.div
          ...
          {/* "QuestLab" wordmark — materializes as moon rises */}
          <motion.span
      ...
      {/* Landscape (includes character) — z-[3], above the moon's rise path */}
      <motion.div
