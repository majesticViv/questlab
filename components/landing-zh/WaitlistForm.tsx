...
export function WaitlistForm() {
  ...
  const [countryDialCode, setCountryDialCode] = useState("+86");
      ...
      <div className="max-w-[500px] mx-auto">
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="waitlist-name-zh" className="text-sm font-medium text-white/80">
              {c.fields.name.label}
            </label>
            <input
              id="waitlist-name-zh"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="waitlist-email-zh" className="text-sm font-medium text-white/80">
              {c.fields.email.label}
            </label>
            <input
              id="waitlist-email-zh"
              type="email"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="waitlist-role-zh" className="text-sm font-medium text-white/80">
              {c.fields.role.label}
            </label>
            <select
              id="waitlist-role-zh"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="waitlist-org-zh" className="text-sm font-medium text-white/80">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="waitlist-phone-zh" className="text-sm font-medium text-white/80">
              {c.fields.phone.label}
            </label>
            <div className="flex gap-2">
              <select
                id="waitlist-country-code-zh"
